 ...
 */
void orb_detect(Mat2<byte> &img, std::vector<KeyPoints> &good_corners, int fastThreshold = FAST_THRESHOLD, int numKeyPoints = NUM_KEY_POINTS, int edge_width = CORNER_WIDTH);
